...
function btnDetalle() {
    return '<img src="assets/img/details.png">';
}

function btnModificar() {
    return '<img src="assets/img/gear.png" style="cursor:pointer; cursor: hand">';
}

function btnEliminar() {
    return '<img src="assets/img/trash.png" style="cursor:pointer; cursor: hand">';
}
